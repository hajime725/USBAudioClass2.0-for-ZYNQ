 ...
 * bmAttribute fields
 */
#define UAC2_CLOCK_SOURCE_TYPE_EXT					0x0
#define UAC2_CLOCK_SOURCE_TYPE_INT_FIXED			0x1
#define UAC2_CLOCK_SOURCE_TYPE_INT_VARIABLE		0x2
#define UAC2_CLOCK_SOURCE_TYPE_INT_PROGRAMMABLE	0x3
...
#define USB_EP2_IN		0x81
#define USB_EP2_OUT		0x01
/* @} */
/**************************** Type Definitions *******************************/
/*
...
/*
 * UAC2 Standard Isochronous Feedback Endpoint descriptor
 */
typedef struct {
	u8 bLength;
	u8 bDescriptorType;
	...
	u8 bMaxPacketSizeH;
	u8 bInterval;
} __attribute__((__packed__))UAC2_ISO_FB_EP_DESC;
...
typedef struct {
	...
	UAC2_ISO_FB_EP_DESC		asIsoFbEpOutDesc;			//STDフィードバックエンドポイント

	USB_STD_IF_DESC			stdAsOutIf2Desc;			//Fordepth
	UAC2_AS_HEADER_DESC 		asOutHdrIf2Desc;
	UAC2_FORMAT_TYPE_I_DESC		asOutFmt1If2Desc;
	USB_EP_DESC			asEpOutIf2Desc;
	UAC2_ISO_EP_DESC		asIsoEpOutIf2Desc;
	UAC2_ISO_FB_EP_DESC		asIsoFbEpOutIf2Desc;			//STDフィードバックエンドポイント
	...
	UAC2_ISO_FB_EP_DESC		asIsoFbEpInDesc;			//STDフィードバックエンドポイント
#endif
} __attribute__((__packed__))USB_CONFIG;
